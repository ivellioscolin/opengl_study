...
init(void)
{
    ...
    static const char render_vs[] = 
        ...
        "void main(void)\n"
        "{\n"
        "    tex_coord = (vec4(in_tex_coord, 0.0f, 1.0f) * tc_rotate).stp;\n"
    ...
    tex[0] = vglLoadTexture("cloud.dds", 0, &image);
...
display(void)
{
    ...
    tc_matrix = vmath::rotate(t * 170.0f, X) * vmath::rotate(t * 137.0f, Y) * vmath::rotate(t * 93.0f, Z);
